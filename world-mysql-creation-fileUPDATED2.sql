...
-- Government Table (table 1) 

DROP TABLE IF EXISTS Government;
CREATE TABLE Government (
  GovernmentType char(20) NOT NULL DEFAULT '',
  LeaderName CHAR(35) NOT NULL DEFAULT '',
  CountryCode CHAR(3) NOT NULL DEFAULT '',
  TermLengthYears INT(1) NOT NULL DEFAULT '0',
  NumParties INT(2) NOT NULL DEFAULT '0',
  NumPoliticians INT(2)NOT NULL DEFAULT '0',
  ActiveMilitary INT(11) NOT NULL DEFAULT '0',
  BUDGET INT(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (CountryCode)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO Government (CountryCode, GovernmentType, LeaderName, TermLengthYears, NumParties, NumPoliticians, ActiveMilitary, BUDGET) VALUES ('USA', 'Federal', 'Richard Dawson', 4, 2, 487, 400103, 115361866);
INSERT INTO Government (CountryCode, GovernmentType, LeaderName, TermLengthYears, NumParties, NumPoliticians, ActiveMilitary, BUDGET) VALUES ('MEX', 'Federal', 'Jared Warner', 7, 5, 442, 581999, 175232153);
INSERT INTO Government (CountryCode, GovernmentType, LeaderName, TermLengthYears, NumParties, NumPoliticians, ActiveMilitary, BUDGET) VALUES ('CAN', 'Parliamentary', 'Kristina Rodriguez', 5, 5, 66, 586076, 386283968);
INSERT INTO Government (CountryCode, GovernmentType, LeaderName, TermLengthYears, NumParties, NumPoliticians, ActiveMilitary, BUDGET) VALUES ('FRA', 'Parliamentary', 'Connie Bennett', 4, 10, 113, 789410, 212970121);

-- Religion Table (table 2)

DROP TABLE IF EXISTS Religion;
CREATE TABLE Religion (
  ReligionName char(20) NOT NULL DEFAULT '',
  Language CHAR(30) NOT NULL DEFAULT '',
  CountryCode CHAR(3) NOT NULL DEFAULT '',
  PercentFollowing FLOAT(4,1) NOT NULL DEFAULT '0.0',
  PRIMARY KEY (ReligionName)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO Religion (ReligionName, CountryCode, Language, PercentFollowing) VALUES ('Islam', 'USA', 'Spanish', 41.6);
INSERT INTO Religion (ReligionName, CountryCode, Language, PercentFollowing) VALUES ('Other', 'BRA', 'Arabic', 85.5);
INSERT INTO Religion (ReligionName, CountryCode, Language, PercentFollowing) VALUES ('Hinduism', 'CHN', 'Turkish', 13.3);
INSERT INTO Religion (ReligionName, CountryCode, Language, PercentFollowing) VALUES ('Buddhism', 'CAN', 'Arabic', 20.2);
INSERT INTO Religion (ReligionName, CountryCode, Language, PercentFollowing) VALUES ('Christianity', 'SAU', 'Arabic', 48.0);

-- Currency Table (Table 3)

DROP TABLE IF EXISTS Currency;
CREATE TABLE Currency (
  CurrencyCode char(20) NOT NULL DEFAULT '',
  CountryCode CHAR(3) NOT NULL DEFAULT '',
  Name CHAR(30) NOT NULL DEFAULT '',
  Symbol CHAR(10) NOT NULL DEFAULT '',
  ExchangeRateToUSD FLOAT(5,2) NOT NULL DEFAULT '0.0',
  CountriesUsedCount INT(3) NOT NULL DEFAULT '1',
  PRIMARY KEY (CurrencyCode)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO Currency (CurrencyCode, CountryCode, Name, Symbol, ExchangeRateToUSD, CountriesUsedCount) VALUES ('USA_CUR', 'USA', 'Real', '$', 2.874, 3);
INSERT INTO Currency (CurrencyCode, CountryCode, Name, Symbol, ExchangeRateToUSD, CountriesUsedCount) VALUES ('CAN_CUR', 'CAN', 'Ruble', '₱', 4.987, 9);
INSERT INTO Currency (CurrencyCode, CountryCode, Name, Symbol, ExchangeRateToUSD, CountriesUsedCount) VALUES ('GBR_CUR', 'GBR', 'Dollar', '₹', 3.112, 18);
INSERT INTO Currency (CurrencyCode, CountryCode, Name, Symbol, ExchangeRateToUSD, CountriesUsedCount) VALUES ('FRA_CUR', 'FRA', 'Pound', '€', 0.647, 5);
